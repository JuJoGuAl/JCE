...
<header id="site-header" class="main-header main-header-overlay" data-sticky-header="false">
    <div class="header-overlay background-overlay transition-all" style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5));"></div>
    <section class="lqd-section lqd-hide-onstuck w-full flex flex-wrap items-center justify-between border-bottom border-white-10 transition-all px-2percent ">		
        <div class="w-50percent flex items-center justify-start py-10 ">
            <a class="navbar-brand flex relative py-15" href="./index-en.php" rel="home">
        ...
        <div class="w-50percent flex items-center justify-end py-10 link-white link-font-normal link-14">
            <div class="dropdown">
                <button class="btn btn-naked leading-16 dropdown-toggle" id="dropdownMenuButton">
                    <div class="ld-fancy-heading relative mr-10 py-5 px-15 mb-0 border-2 border-black rounded-100 animation-element" style="background-color: rgba(255, 255, 255, 0.685); font-size: 12px; font-weight: 400; border: none; letter-spacing: normal;">
                        <h5 class="ld-fh-element inline-block relative text-14 uppercase tracking-1 m-0" style="font-size: 12px; font-weight: 400; letter-spacing: normal; border: none;">DISTRIBUTOR ACCESS</h5>
                    </div>
                </button>
                <div class="dropdown-content" id="dropdown-content" style=" border-radius: 21px; background-color: #ffffffe0;">
                    <a style="padding: 5px 15px;" href="http://www.rjce.cl/repre/repre">PURCHASE ORDER</a>
                    <a style="padding: 5px 15px;" href="https://jce.appingcsa.com/">AFTER-SALES PLATFORM</a>
                </div>
            </div>
            <div class="ld-dropdown-menu link-black flex relative pl-20 ml-20 border-left border-white-10" role="menubar">
                <a href="./" curosor="pointer">
                    <span ><img style="width: 25px;" src=".\images\cambio-idioma.png"><span class="text-white">&nbsp;ESPAÑOL</span></span>
                </a>
            </div>
            <div class="ld-dropdown-menu link-black flex relative pl-20 ml-20 border-left border-white-10" role="menubar">
                <a href="./productos-en.php" curosor="pointer">
            ...
            <div class="pl-20 ml-20 border-left border-white-10 ld-module-search lqd-module-search-slide-top items-center" data-module-style="lqd-search-style-slide-top">
                <span class="ld-module-trigger collapsed lqd-module-trigger-txt-left lqd-module-show-icon lqd-module-icon-plain text-14" role="button" data-ld-toggle="true" data-bs-toggle="collapse" data-bs-target="#search-header-top" aria-controls="search-header-top" aria-expanded="false">
                    ...
                    <span class="ld-module-trigger-icon text-white">CONTACT</span>
                </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col col-12 py-0">
                                                            <span class="mb-0 lqd-form-control-wrap relative">
                                                                <input class="text-black px-2em text-14 font-normal bg-yellow-100" type="text" name="entry.1712204619" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Name">
                                                        ...
                                                        <div class="col col-12 py-0">
                                                            <span class="mb-0 lqd-form-control-wrap relative">
                                                                <input class="text-black px-2em text-14 font-normal bg-yellow-100" type="phone" name="entry.389312874" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Phone">
                                                        ...
                                                        <div class="col col-12 py-0">
                                                            <span class="mb-0 lqd-form-control-wrap relative">
                                                                <input class="text-black px-2em text-14 font-normal bg-yellow-100" type="text" name="entry.216002328" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Message">
                                                            </span>
                                                        </div>
                                                        <div style="width:100%;"></div>
                                                        <div class="col col-12 py-0">
                                                            <input type="submit" value="Send" class="mb-0 font-bold text-secondary has-spinner text-16" style="color: white; background-color: #181818e0;">
                                                        </div>
                                                    </div>
                                                </form>
